...
import '../../theme/app_text_styles.dart';
import '../../utils/constants.dart';
// Removed the AppScaffold import since it's managed by MainShell globally now
...
class _MapScreenState extends State<MapScreen> {
  ...
  @override
  Widget build(BuildContext context) {
    // FIX: Changed AppScaffold to a standard Scaffold to eliminate duplicate navigation items
    return Scaffold(
      body: _isLoading
          ? const Center(child: CircularProgressIndicator())
          : Stack(
